...
RESULT_DIR = Path(r"D:\HaitongNi\MEngProject\repos\ReStraV\results\genvidbench_common1000")
RESULT_DIR.mkdir(parents=True, exist_ok=True)

FEATURE_CACHE = RESULT_DIR / "restrav_genvidbench_common1000_features.npz"
META_CACHE = RESULT_DIR / "restrav_genvidbench_common1000_metadata.csv"

PRED_CSV = RESULT_DIR / "restrav_genvidbench_common1000_predictions.csv"
RESULT_TXT = RESULT_DIR / "restrav_genvidbench_common1000_results.txt"

MODEL_OUT = RESULT_DIR / "restrav_genvidbench_common1000_model.pt"
MEAN_OUT = RESULT_DIR / "restrav_genvidbench_common1000_mean.npy"
STD_OUT = RESULT_DIR / "restrav_genvidbench_common1000_std.npy"
TAU_OUT = RESULT_DIR / "restrav_genvidbench_common1000_best_tau.npy"
...
def extract_or_load_features():
    ...
    if failed_rows:
        failed_csv = RESULT_DIR / "restrav_genvidbench_common1000_failed.csv"
...
Dataset: GenVidBench common-1000
Input CSV: {INPUT_CSV}
