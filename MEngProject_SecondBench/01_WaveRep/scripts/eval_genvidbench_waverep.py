...
WAVEREP_DEMO_DIR = Path(r"D:\HaitongNi\MEngProject\repos\WaveRep-SyntheticVideoDetection\demo")
sys.path.insert(0, str(WAVEREP_DEMO_DIR))
...
INPUT_CSV = r"D:\HaitongNi\MEngProject_SecondBench\metadata\genvidbench_common1000.csv"
